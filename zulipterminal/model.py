...
class Model:
    ...
    def _handle_typing_event(self, event: Event) -> None:
        ...
        if (
            ...
            and sender_email in [email for email in narrow[0][1].split(", ")]
            and sender_id != self.user_id
        ):
            print(self.user_dict[sender_email].keys())
            if event["op"] == "start":
                #sender_email = self.user_dict[sender_email]["email"]
                print("start",type(active_conversation_info))
                ...
                #sender_email = self.user_dict[sender_email]["email"]
                print("stop",type(active_conversation_info))
